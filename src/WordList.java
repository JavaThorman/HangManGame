   ...
   public ArrayList<String> wordList = new ArrayList<String>();
    ...
    public void showWords() {
        ...
        for (int i = 0; i < wordList.size(); i++) {
            String dubbelOrd = wordList.get(i);
            if (dubbelOrd.equalsIgnoreCase(wordList.get(i))) {
                wordList.remove(dubbelOrd);
            }
        }
        ...
        public void removeWord() {
            ...
            for (int i = 0; i < wordList.size(); i++) {
                if (wordList.get(i).equalsIgnoreCase(wordToRemove)) {
                    System.out.println("Word: "+wordList.get(i)+" has been removed from the list!");
                } else {
                    System.out.println("That word does not exist! Back to the lobby you go...");
                }
            }
        }
}
